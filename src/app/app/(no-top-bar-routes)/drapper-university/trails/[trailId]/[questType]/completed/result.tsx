...
import { badgeLevelMap } from "@/app/app/(no-top-bar-routes)/drapper-university/data";
import { dataStore } from "@/app/app/(no-top-bar-routes)/drapper-university/data-store";
import { useStore } from "@/app/app/(no-top-bar-routes)/drapper-university/store";
import { TrailId } from "@/app/app/(no-top-bar-routes)/drapper-university/types";
      ...
      <Card className="w-full max-w-lg p-4 text-center">
        ...
        <CardFooter className="flex flex-col gap-2">
          {!sessionUser && (
            <Link
              className="w-full"
              href={`/app/drapper-university/trails/${trailId}/${questType}/completed?signin-dialog=true`}
            >
          ...
          <Link
            className="w-full"
            href={`/app/drapper-university/trails/${trailId}`}
          >
